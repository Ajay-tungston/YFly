                            ...
                            <div className='flex justify-between max-lg:flex-col items-center h-[300px] px-28 max-lg:py-10'>
                                ...
                                <div className='flex max-lg:-ml-5 max-md:-ml-0'>
                                    ...
                                    <div className='ml-3'>
                                        ...
                                        <div className='text-[#30589F] font-lato text-[20px] max-xl:text-[15px]'>$25000</div>
                                    </div>
                                </div>
                                ...
                                <div className='flex items-center max-md:-ml-0'>
                                    ...
                                    <div className='ml-3'>
                                        ...
                                        <div className='text-[#30589F] font-lato text-[20px] max-xl:text-[15px]'>$10000</div>
                                    </div>
                                </div>
                                ...
                                <div className='flex max-lg:-ml-12 max-md:-ml-2'>
                                    ...
                                    <div className='ml-3'>
                                        ...
                                        <div className='text-[#30589F] font-lato text-[20px] max-xl:text-[15px]'>$650</div>
                                    </div>
                                </div>
                            </div>
