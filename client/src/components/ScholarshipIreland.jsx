export default function Scholarships() {
    const scholarships = [
      {
        ...
        image: "/images/trinity.jpeg", // Replaced 'logo' with 'image'
      },
      {
        title: "NUI Galway International Scholarship",
        ...
        image: "/images/nui.png", // Replaced 'logo' with 'image'
      },
      {
      ...
      },
      {
        ...
        image: "/images/walsh.avif", // Replaced 'logo' with 'image'
      },
      {
        ...
        image: "/images/ucd.jpeg", // Replaced 'logo' with 'image'
      },
      {
        title: "Maynooth University Scholarship",
        ...
        image: "/images/maynooth.png", // Replaced 'logo' with 'image'
      },
      {
        title: "Technological University Dublin Scholarship",
        description: "Merit scholarships reward academic excellence (high GPA, test scores) or exceptional athletic abilities.",
        image: "/images/dublin.png", // Replaced 'logo' with 'image'
      },
      {
    ...
    hover:shadow-xl transition max-w-3xl mx-auto m-10">
          <div className="text-center md:text-left md:flex-1">
            <h3 className="text-lg font-Urbanist text-gray-900">The Bayer Foundations Fellowship Program</h3>
            <hr />
