...
const Pros = () => {
  ...
  const prosList = [
    {
      ...
      content:
        "Globally recongnized universities with strong research programs.",
    },
    {
      title: "Work Opportunities",
      content:
        "Graduates can stay and work for up to three years.",
    },
    {
      title: "Visa& PR Pathways",
      content:
        "International students have options for work and residency.",
    },
  ...
  const consList = [
    { title: "High Costs of Living", content: "Rent and daily expenses can be expensive." },
    { title: "Limited jobs", content: "Fewer job opportunities com-pared to larger countries." },
    { title: "Far from Home", content: "Long travel times." },
    { title: "Unstable Weather", content: "Rapid weather change and frequent rain in some regions." },
    { title: "Housing Issues", content: "Hard to find affordable accommodation." },
  ];
