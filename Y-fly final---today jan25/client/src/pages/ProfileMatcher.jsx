            ...
            <div className='bg-[#0E1B2C] pb-10'>
                ...
                <div className='bg-white h-[70vh] rounded-b-[200px] max-md:rounded-b-[80px] relative'>
                    ...
                    <div className='flex justify-center'>
                        ...
                        <div className='absolute text-center top-[13.5rem] font-dela text-[5.4rem] leading-[6.5rem] max-xl:text-[4rem] max-xl:leading-[4.8rem] max-lg:text-[3.2rem] max-lg:leading-[3.5rem]  max-md:text-[1.8rem] max-md:leading-[3rem]'>Your personalised<br/> course search.</div>
                        <div className='absolute top-[29rem] font-urban font-bold text-[18px] max-xl:top-[25rem] max-md:text-[15px] max-lg:top-[22rem] max-md:top-[20rem]'>Your pathway to find the perfect course</div>
                    </div>
                </div>
                ...
                {/*--------------------------------- white grid section------------------------------------------ */}
                <div  className=" bg-white bg-cover bg-center rounded-[200px] max-xl:rounded-[150px] max-md:rounded-[80px] pt-16 px-24 pb-32 mt-10 max-xl:px-12  max-lg:px-10 max-md:px-4"
                    ...
                    <div className=' w-[72%] max-lg:w-[100%]'>
                        ...
                        <div className='flex justify-between mt-12 mb-16'>
                            <div className='w-[30%]  max-xl:w-[32%] bg-[#C9851E] px-10 max-xl:px-5 max-lg:px-7 max-md:px-3 py-4 max-md:py-2 rounded-[50px] flex justify-between  border-black border-[1px]'>
                                <div className='flex'>
                                    <img src={ascend} alt='ascend' width={40} className='max-xl:w-[2rem] max-md:w-[0.5rem]'/>

                                    <div className=' text-white font-urban ml-4 max-lg:ml-2 '>
                                        <div className=' text-[22px] max-xl:text-[18px] max-md:text-[15px] font-bold  -mb-1'>16</div>
                                        <div className=' text-[17px] max-xl:text-[15px] max-md:text-[12px] font-semibold'>Ascend</div>
                                    </div>
                                </div>

                                <img src={info} alt='info' width={25} className=' max-md:w-[0.5rem]'/>
                            </div>
                            ...
                            <div className='w-[30%] max-xl:w-[32%] bg-[#2B7CD6] px-10 max-xl:px-5 max-lg:px-7 max-md:px-3 py-4 max-md:py-2 rounded-[50px] flex justify-between border-black border-[1px]'>
                                <div className='flex'>
                                    <img src={contender} alt='contender' width={40} className='max-xl:w-[2rem] max-md:w-[0.5rem]'/>

                                    <div className=' text-white font-urban ml-4 max-lg:ml-2 max-md:ml-1'>
                                        <div className=' text-[22px] max-xl:text-[18px] max-md:text-[15px] font-bold  -mb-1'>32</div>
                                        <div className=' text-[17px] max-xl:text-[15px] max-md:text-[12px] font-semibold'>Contender</div>
                                    </div>
                                </div>
                            ...
                            <div className='w-[30%] max-xl:w-[32%] bg-[#209F71] px-10 max-xl:px-5 max-lg:px-7 max-md:px-3 py-4 max-md:py-2 rounded-[50px] flex justify-between  border-black border-[1px]'>
                                <div className='flex'>
                                    <img src={shieldtick} alt='shieldtick' width={40} className='max-xl:w-[2rem] max-md:w-[0.5rem]'/>

                                    <div className=' text-white font-urban ml-4 max-lg:ml-2 max-md:ml-1'>
                                        <div className=' text-[22px] max-xl:text-[18px] max-md:text-[15px] font-bold  -mb-1'>64</div>
                                        <div className=' text-[17px] max-xl:text-[15px] max-md:text-[12px] font-semibold'>Frontrunner</div>
                                    </div>
                                </div>
                        ...
                        <div>
                            <div className='flex items-center mb-5'>
                                <img src={ascendorange} width={40} alt='ascend' className='max-md:w-[1.2rem]' />
                                <div className='font-urban ml-3 text-[25px] max-md:text-[18px] font-bold'>16 Ascend Universities</div>
                            </div>
                            {/* ------------------------------harvard university------------------------------------ */}
                            ...
                            <div className='flex justify-between my-12'>
                                ...
                                <button className='text-[#30589F] font-urban font-bold'>View More Universities</button>
                                <div className='border-t-[0.5px] border-[#0E1B2C] my-4 w-[40%]'></div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div className='flex items-center mb-5'>
                                <img src={contenderblue} width={40} alt='contender' className='max-md:w-[1.2rem]'/>
                                <div className='font-urban ml-3 text-[25px] max-md:text-[18px] font-bold'>32 Contender Universities</div>
                            </div>
                            {/* ------------------------------harvard university------------------------------------ */}
                            <div className='flex justify-between max-md:flex-col max-md:gap-y-2'>
                        ...
                        <div>
                            <div className='flex items-center mb-5'>
                                <img src={contendergreen} width={40} alt='contender' className='max-md:w-[1.2rem]'/>
                                <div className='font-urban ml-3 text-[25px] max-md:text-[18px] font-bold'>64 Frontrunner Universities</div>
                            </div>
                            {/* ------------------------------harvard university------------------------------------ */}
                            <div className='flex justify-between max-md:flex-col max-md:gap-y-2'>
                        ...
                        <div className=' flex justify-around'>
                            <div className='bg-white w-[40%] max-md:w-[95%] absolute top-[30%] rounded-[30px] p-8'>
                                <div className='flex justify-between items-center mb-5'>
                                    <div className='font-dela  text-[18px]'>Recommended courses</div>
                                ...
                                <div className='overflow-y-auto h-[30vh] '>
                                    <div className='flex justify-between font-urban mb-3 mr-4'>
                                        ...
                                        <button onClick={handleDetails} className='text-[#2B7CD6] text-[14px] font-semibold'>View Details</button>
                                    </div>

                                    <div className='flex justify-between font-urban mb-3 mr-4'>
                                        <div>Bachelors in Mathematics</div>
                                        <button className='text-[#2B7CD6] text-[14px] font-semibold'>View Details</button>
                                    </div>

                                    <div className='flex justify-between font-urban mb-3 mr-4'>
                                        <div>Bachelors in Molecular and Cellular Biology (MCB)</div>
                                        <button className='text-[#2B7CD6] text-[14px] font-semibold'>View Details</button>
                                    </div>
                    ...
                    <div className='bg-black bg-opacity-50 h-[100vh] fixed inset-0 '>
                        <div className=' flex justify-around'>
                            <div className='bg-white w-[40%] max-md:w-[95%] absolute top-[20%] rounded-[30px] p-8'>
                                ...
                                <div>
                                    <div className='py-5 font-dela text-[18px]'>Course Details</div>

                                    <div className='flex '>
                                        <div className='flex w-[60%]'>
                                            <img src={wallet} alt='wallet' />
                                            <div className='ml-3'>
                                                <div className='font-urban text-[14px]'>Tuition Fee</div>
                                                <div className='font-dela text-[13px]'>USD 49,653/year</div>
                                            </div>
                                        </div>
                                        ...
                                        <div className='flex w-[40%]'>
                                            <img src={wallet} alt='wallet' />
                                            <div className='ml-3'>
                                                <div className='font-urban text-[14px]'>Eligibility</div>
                                    ...
                                    <div className='flex mt-5 '>
                                        <div className='flex'>
                                            <img src={wallet} alt='wallet' />
                                            <div className='ml-3'>
                                                <div className='font-urban text-[14px]'>English Proficiency Requirement</div>
                                                <div className='font-dela text-[13px]'>Overall score of 7, with min. 7 in each band (IELTS)</div>
                                            </div>
                                        </div>
                                    </div>

                                    <div className='mt-8 flex justify-between'>
                                        <button onClick={handleModal} className='bg-white px-4 py-2 border-[#0F62AF] text-[#0F62AF] text-[13px] font-urban border-[2px] rounded-[20px]'>
                                            Back to results
                                        </button>
                                        <button onClick={handleApply} className=' bg-[#2B7CD6] text-[14px] font-urban text-white flex items-center px-5 py-1 rounded-full shadow-right-bottom border-[1px] shadow-black border-black'>
                                            Apply Now
                                        </button>
                                    </div>
                            ...
                            <div className='bg-white w-[40%] max-md:w-[95%] absolute top-[20%] rounded-[30px] p-8'>
                                ...
                                <div className='my-5'>
                                    ...
                                    <div className='py-4 px-5 border-black border-[1px] rounded-[30px] '>
                                        <div className='flex justify-between'>
                                            <div className='text-[#BFBFBF] font-urban'>Select intake year</div>
                                    ...
                                    <div className='py-4 px-5 border-black border-[1px] rounded-[30px] mt-3 '>
                                        <div className='flex justify-between'>
                                            <div className='text-[#BFBFBF] font-urban'>Select intake month</div>
                                ...
                                <div className='flex justify-between '>
                                    <button onClick={handleDetails} className='bg-white px-4 py-2 border-[#0F62AF] text-[#0F62AF] text-[13px] font-urban border-[2px] rounded-[20px]'>
                                        Back to details
                                    </button>
                                    <button onClick={handleDocuments} className=' bg-[#2B7CD6] text-[14px] font-urban text-white flex items-center px-5 py-1 rounded-full shadow-right-bottom border-[1px] shadow-black border-black'>
                                        Next
                                    </button>
                                </div>
                            </div>
                            ...
                            <div className='bg-white w-[40%] max-md:w-[95%] absolute top-[5%] rounded-[30px] p-8'>
                                ...
                                <div className='my-5'>
                                    ...
                                    <div className='py-3 px-5 border-black border-[1px] rounded-[30px] '>
                                        <div className='flex justify-between'>
                                            <div className='text-[#BFBFBF] font-urban'>Identity Documents</div>
                                        ...
                                        {identitydoc && (
                                            <div>
                                                ...
                                                <div className='py-3 px-5 mt-2 text-[14px] flex justify-between text-[#2B7CD6] font-dela border-black border-[1px] rounded-[15px] '>
                                                    Passport Front
                                                    <input type='file' className='hidden' ref={passportFrontRef} onChange={handlePassportFrontChange} />
                                                    <div className=''>
                                                        <button
                                                ...
                                                <div className='py-3 px-5 mt-2 flex justify-between text-[14px] text-[#2B7CD6] font-dela border-black border-[1px] rounded-[15px] '>
                                                    Passport Back
                                                    <button className=" border-none font-urban font-semibold text-[#2B7CD6] border">Upload file</button>
                                                </div>
                                                <div className='py-3 px-5 mt-2 flex justify-between text-[14px] text-[#2B7CD6] font-dela border-black border-[1px] rounded-[15px] '>
                                                    CV/Resume
                                                    <button className=" border-none font-urban font-semibold text-[#2B7CD6] border">Upload file</button>
                                    ...
                                    <div className='py-3 px-5 border-black border-[1px] rounded-[30px] mt-3'>
                                        <div className='flex justify-between'>
                                            <div className='text-[#BFBFBF] font-urban'>Education Documents</div>
                                    ...
                                    <div className='py-3 px-5 border-black border-[1px] rounded-[30px] mt-3'>
                                        <div className='flex justify-between'>
                                            <div className='text-[#BFBFBF] font-urban'>Work Experience Documents</div>
                                            <button onClick={handleYearDrop}>
                                                <img src={down} width={15} alt='down' />
                                            </button>
                                        </div>
                                    ...
                                    <div className='py-3 px-5 border-black border-[1px] rounded-[30px] mt-3'>
                                        <div className='flex justify-between'>
                                            <div className='text-[#BFBFBF] font-urban'>English Proficiency Documents</div>
                                            <button onClick={handleYearDrop}>
                                                <img src={down} width={15} alt='down' />
                                            </button>
                                        </div>
                                    ...
                                    <div className='py-3 px-5 border-black border-[1px] rounded-[30px] mt-3'>
                                        <div className='flex justify-between'>
                                            <div className='text-[#BFBFBF] font-urban'>Extra Curricular Document</div>
                                            <button onClick={handleYearDrop}>
                                                <img src={down} width={15} alt='down' />
                                            </button>
                                        </div>
                                    ...
                                    <div className='py-3 px-5 border-black border-[1px] rounded-[30px] mt-3'>
                                        <div className='flex justify-between'>
                                            <div className='text-[#BFBFBF] font-urban'>Recommendation Documents</div>
                                            <button onClick={handleYearDrop}>
                                                <img src={down} width={15} alt='down' />
                                            </button>
                                        </div>
                                    ...
                                    <div className='py-3 px-5 border-black border-[1px] rounded-[30px] mt-3'>
                                        <div className='flex justify-between'>
                                            <div className='text-[#BFBFBF] font-urban'>Other Documents</div>
                                            <button onClick={handleYearDrop}>
                                                <img src={down} width={15} alt='down' />
                                            </button>
                                        </div>
                                ...
                                <div className='flex justify-between '>
                                    <button onClick={handleApply} className='bg-white px-4 py-2 border-[#0F62AF] text-[#0F62AF] text-[13px] font-urban border-[2px] rounded-[20px]'>
                                        Back
                                    </button>
                                    <button onClick={handleDocuments} className=' bg-[#2B7CD6] text-[14px] font-urban text-white flex items-center px-5 py-1 rounded-full shadow-right-bottom border-[1px] shadow-black border-black'>
                                        Submit
