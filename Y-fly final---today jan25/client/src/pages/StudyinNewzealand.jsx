    ...
    return (
        <div className=' bg-[#0E1B2C] pb-10'>
            ...
            <div className='relative '>
                ...
                <div className='flex justify-center'>
                    <div className=' text-center text-white text-[5.5rem] max-xl:text-[4rem] max-lg:text-[3rem] max-md:text-[1rem] max-lg:leading-[55px] max-md:leading-[25px]  max-xl:leading-[70px] leading-[100px] font-lato absolute top-[17rem] max-xl:top-[15rem] max-lg:top-[12rem] max-md:top-[5rem]'>Study in<br /> New Zea-land</div>
                </div>
