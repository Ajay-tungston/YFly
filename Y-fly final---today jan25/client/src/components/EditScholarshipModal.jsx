...
const EditScholarshipModal = (props,setEditingScholarship) => {
    ...
    const [editScholarship, setEditScholarship] = useState({
     ...
     // Close the form and return to the scholarship list
    const handleCancel = () => {
        setModal(false);
    }    
        ...
        const getScholarshipData = async () => {
          try {
            ...
            setEditScholarship({
                ...
                types_of_scholarship: data.types_of_scholarship || "",
                ...
                scholarship_applicability: data.scholarship_applicability || "",
                brochure: null,
              testRequirements: data.testRequirements || [
                { testRequirement: 'Select', overallScore: '' },
              ],
              specialRestrictions: data.specialRestrictions || [
                { specialRestriction: 'Select' },
              ],
            });
          } catch (error) {
    ...
    //     setEditScholarship((prevEditScholarship) => ({
    //         ...prevEditScholarship,
    //         [name]: value,
    //     }));
    // };
    ...
    const handleSubmit = async (e) => {
        ...
        for (const key in editScholarship) {
            if (key === 'testRequirements' || key === 'specialRestrictions') {
                formData.append(key, JSON.stringify(editScholarship[key]));
            } else {
                formData.append(key, editScholarship[key]);
            }
        }
    
        if (editScholarship.brochure) {
            formData.append('brochure', editScholarship.brochure);
        }
        ...
        try {
            ...
            if (props.setEditingScholarship) {
                props.setEditingScholarship(false);
            }
        } catch (error) {
        ...
        {modal && (
            <div className="fixed inset-0 flex items-center justify-center z-10">
                ...
                <div className='flex justify-between items-center font-urban'>
                    <div>
                        <div className='text-[#0E1B2C] font-bold'>Edit Scholarship</div>
                        <div className='text-[#898C9A] text-[0.8rem]'>Edit scholarship details here.</div>
                    </div>
                ...
                <div className='font-urban mr-10 max-xl:mr-0 '>
                    ...
                    <div className='w-[20%] max-xl:w-[15%]'>Scholarship Name</div>
                        ...
                        value={editScholarship.scholarship_name}
                        id='scholarshipname'
                        type='text'
                        ...
                        border text-gray-800 bg-[#F9F9F9] rounded-md">
                            {editScholarship.types_of_scholarship}
                            <img src={down} alt="down" width={12} className="ml-8" />
                        </button>
                        {/* Dropdown */}
                        {isOpen1 && (
                            <div className="absolute mt-[7.3rem] ml-[51rem] max-xl:ml-[32rem] w-[18.5%] max-xl:w-[21%] bg-[#F9F9F9] border border-[#898C9A] rounded-md shadow-lg z-10">
                                <ul className="">
                ...
                <div className='font-urban mr-10 max-xl:mr-0'>
                    <div className='flex text-[0.9rem]'>
                        ...
                        className="w-[30%] flex items-center px-5 py-[10px] justify-between text-[#898C9A] border-[#898C9A] border text-gray-800 bg-[#F9F9F9] rounded-md">
                            {editScholarship.country}
                            <img src={down} alt="down" width={12} className="ml-8" />
                        </button>
                        {/* Dropdown */}
                        {isOpen2 && (
                            <div className="absolute mt-10 ml-[13.5rem] max-xl:ml-[7rem] w-[22%] bg-[#F9F9F9] border border-[#898C9A] rounded-md shadow-lg z-10">
                ...
                <div className='font-urban mr-10 max-xl:mr-0'>
                    <div className='flex text-[0.9rem]'>
                        ...
                        type='button'
                            ...
                            className="w-[30%] flex items-center px-5 py-[10px] justify-between text-[#898C9A] border-[#898C9A] border text-gray-800 bg-[#F9F9F9] rounded-md">
                            {editScholarship.student_citizenship}
                            <img src={down} alt="down" width={12} className="ml-8" />
                        </button>
                        {/* Dropdown */}
                        {isOpen6&& (
                ...
                <div className='font-urban mr-10 max-xl:mr-0 '>
                    <div className='flex items-center text-[0.9rem]'>
                        ...
                        className="w-[30%] flex items-center px-5 py-[10px] justify-between text-[#898C9A] border-[#898C9A] border text-gray-800 bg-[#F9F9F9] rounded-md">
                            {editScholarship.course_level}
                            <img src={down} alt="down" width={12} className="ml-8" />
                        </button>
                        {/* Dropdown */}
                        {isOpen3 && (
                            <div className="absolute mt-[9.5rem] ml-[13.5rem] max-xl:ml-[7rem] w-[22%] bg-[#F9F9F9] border border-[#898C9A] rounded-md shadow-lg z-10">
                                <ul className="">
                        ...
                        <button
                            ...
                            {editScholarship.area_of_study}
                            <img src={down} alt="down" width={12} className="ml-8" />
                        </button>
                        {/* Dropdown */}
                        {isOpen4 && (
                            <div className="absolute mt-[16.9rem] max-xl:mt-[18.5rem]  ml-[51rem] max-xl:ml-[32rem] w-[18.5%] max-xl:w-[21%] bg-[#F9F9F9] border border-[#898C9A] rounded-md shadow-lg z-10">
                ...
                <div className='font-urban mr-10 max-xl:mr-0'>
                        <div className='flex text-[0.9rem]'>
                            ...
                            <button
                                ...
                                {editScholarship.scholarship_amount}
                                <img src={down} alt="down" width={12} className="ml-8" />
                            </button>
                            {/* Dropdown */}
                            {isOpen5 && (
                            ...
                            <input
                                ...
                                placeholder="Select"
                                type="date"
                                value={editScholarship.scholarship_deadline}
                ...
                <div className='font-urban mr-10 max-xl:mr-0'>
                    <div className='flex text-[0.9rem]'>
                        ...
                        <textarea
                                ...
                                rows="5"
                                name="overview"
                                value={editScholarship.overview}
                ...
                <div className='font-urban mr-10 max-xl:mr-0'>
                    <div className='flex text-[0.9rem]'>
                        ...
                        <textarea
                                ...
                                rows="5"
                                value={editScholarship.eligibility_criteria}
                ...
                <div className='font-urban mr-10 max-xl:mr-0'>
                    <div className='flex text-[0.9rem]'>
                        ...
                        <textarea
                                ...
                                value={editScholarship.application_process}
                            ></textarea>
                    </div>
                </div>
                <div className='border-[#BFBFBF] border-b-[1px] my-5'></div>
                ...
                <div className='font-urban mr-10 max-xl:mr-0'>
                    {testRequirements.map((requirement, index) => (
                        ...
                        <select
                            ...
                            value={requirement.testRequirements}
                        ...
                        <input
                            className='w-[25%] max-xl:w-[30%] bg-[#F9F9F9] border border-[#898C9A] rounded-md placeholder:text-[0.8rem]'
                            placeholder='Enter here'
                            value={editScholarship.testRequirements.overallScore}
                ...
                <div className='font-urban mr-10 max-xl:mr-0'>
                    {specialRestrictions.map((restriction, index) => (
                        ...
                        <button
                            ...
                            className="w-[30%] flex items-center px-5 py-[10px] justify-between text-[#898C9A] border-[#898C9A] border text-gray-800 bg-[#F9F9F9] rounded-md"
                        >
                            {editScholarship.specialRestrictions}
                            <img src={down} alt="down" width={12} className="ml-8" />
                        </button>
                ...
                <div className='font-urban mr-10 max-xl:mr-0'>
                    <div className='flex text-[0.9rem]'>
                        ...
                        <button
                            ...
                            className="w-[30%] flex items-center px-5 py-[10px] justify-between text-[#898C9A] border-[#898C9A] border text-gray-800 bg-[#F9F9F9] rounded-md">
                            {editScholarship.scholarship_applicability}
                            <img src={down} alt="down" width={12} className="ml-8" />
                        </button>
                        {/* Dropdown */}
                        {isOpen8&& (
                            ...
                            <div className='flex'>
                                <div className=''>
                                    <label htmlFor="upload-brochure"
                                        ...
                                        {brochure ? brochure.name : 'Upload brochure ( JPG, PNG )'}
                                    </label>
                                    <input
                                        id="upload-brochure"
                                        type="file"
