export default function Scholarships() {
  const scholarships = [
    {
      title: "Commonwealth Scholarships By British Council",
      description: "Provided by the government with specific quotas for different social and economic groups",
      image: "/images/scholar5.png", // Replaced 'logo' with 'image'
    },
    {
      ...
      image: "/images/scholar9.png", // Replaced 'logo' with 'image'
    },
    {
      title: "The Felix Scholarships",
    ...
    },
    {
      ...
      image: "/images/scholar8.png", // Replaced 'logo' with 'image'
    },
    {
      title: "Charles Wallace India Scholarships",
      ...
      image: "/images/scholar3.png", // Replaced 'logo' with 'image'
    },
    {
      title: "Merit Based Scholarships",
      description: "Merit scholarships reward academic excellence (high GPA, test scores) or exceptional athletic abilities.",
      image: "/images/scholar4.png", // Replaced 'logo' with 'image'
    },
    {
      title: "Dr. Manmohan Singh Scholarships",
      ...
      image: "/images/scholar6.png", // Replaced 'logo' with 'image'
    },
  ];
  ...
  hover:shadow-xl transition max-w-3xl mx-auto m-10">
        ...
        <img
          src="/images/scholar2.png"
          alt="Dr. Manmohan Singh Scholarships"
