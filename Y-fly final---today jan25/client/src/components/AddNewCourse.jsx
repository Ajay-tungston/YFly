...
//         overview: "",
//         intakes: [{ month: "", year: "" }],
//         course_test_requirements: [{ course_test_name: "", overallScore: "" }],
//         course_eligibility: [
//             { criteria: "", gpaRange: "", backlogRange: "", workExperience: ""},
//         ],
//         course_application: [{ application_requirement: "", isRequired: false }],
//         job_roles: [{ jobrole: "" }],
//         top_recruiters: [{ recruiters_name: "", recruiters_logo: null }],
...
//         //update the addcourse state with the latest fields
//         const updatedCourse = {
//             ...addCourseData,
//             intakes: intakes,
//             course_test_requirements:course_test_requirements,
//             course_eligibility: course_eligibility,
//             course_application: course_application,
//             job_roles: job_roles,
//             top_recruiters: top_recruiters,
//             course_scholarship: course_scholarship,
//             course_tution_fee: course_tution_fee,
...
//     const updatedcourse_test_requirements = [...addCourseData.testRequirements];
...
//     setAddCourseData((prevData) => ({
//         ...prevData,
//         testRequirements: [...prevData.testRequirements, { testRequirementName: "Select", overallScore: "" }],
//     }));
// };

// const handleRemoveTestRequirement = (index) => {
//     const updatedTestRequirements = addCourseData.testRequirements.filter((_, i) => i !== index);
//     setAddCourseData((prevData) => ({
//         ...prevData,
//         testRequirements: updatedTestRequirements,
//     }));
...
//     const updatedEligibilityRequirements = [...addCourseData.eligibilityRequirements];
...
//             { requirementType: "", gpaRange: "", backlogRange: "", workExperience: "", entranceExam: "" },
//         ],
//     }));
// };

// const handleEligibilityRemoveRequirement = (index) => {
//     const updatedEligibilityRequirements = addCourseData.eligibilityRequirements.filter((_, i) => i !== index);
//     setAddCourseData((prevData) => ({
//         ...prevData,
//         eligibilityRequirements: updatedEligibilityRequirements,
//     }));
...
//     const updatedApplicationRequirements = [...addCourseData.application_requirements];
...
//     setAddCourseData((prevData) => ({
//         ...prevData,
//         application_requirements: [...prevData.application_requirements, { requirement: '', isRequired: false }],
//     }));
// };

// const handleApplicationRemoveRequirement = (index) => {
//     const updatedApplicationRequirements = addCourseData.application_requirements.filter((_, i) => i !== index);
//     setAddCourseData((prevData) => ({
//         ...prevData,
//         application_requirements: updatedApplicationRequirements,
//     }));
...
//     const updatedJobRoles = addCourseData.job_roles.filter((_, i) => i !== index);
//     setAddCourseData((prevData) => ({
//         ...prevData,
...
//     setAddCourseData((prevData) => ({
//         ...prevData,
//         top_recruiters: [...prevData.top_recruiters, { recruiters_name: '', logo: null }],
//     }));
// };

// const handleRemoveTopRecruiters = (index) => {
//     const updatedRecruiters = addCourseData.top_recruiters.filter((_, i) => i !== index);
//     setAddCourseData((prevData) => ({
//         ...prevData,
//         top_recruiters: updatedRecruiters,
//     }));
...
//     const updatedScholarships = addCourseData.scholarship_applicable.filter((_, i) => i !== index);
//     setAddCourseData((prevData) => ({
//         ...prevData,
//         scholarship_applicable: updatedScholarships,
//     }));
...
//     const updatedFundingOptions = addCourseData.funding_options.filter((_, i) => i !== index);
//     setAddCourseData((prevData) => ({
//         ...prevData,
//         funding_options: updatedFundingOptions,
//     }));
...
//                     <div className='text-[#898C9A] text-[0.8rem]'>Upload course details here.</div>
//                 </div>
//                 <div className='flex text-[0.8rem] font-bold'>
//                     <button onClick={handleCancel} className='border-[#BFBFBF] border-[1px] mr-3 px-3 py-1 rounded-[9px] text-[#BFBFBF]'>Cancel</button>
...
//             <div className="w-[10%] max-xl:w-[5%] flex items-center justify-center">of</div>
...
//                         <li
//                             onClick={() => handleDiscipline("Agriculture, Forestry & Fishery")}
//                             className="px-4 py-2 cursor-pointer hover:bg-[#7f848dda] hover:text-white"
//                         >
...
//                         </li>
//                         <li
//                             onClick={() => handleDiscipline("Commerce, Business & Administration")}
//                             className="px-4 py-2 cursor-pointer hover:bg-[#7f848dda] hover:text-white"
//                         >
...
//             <div className="w-[10%] max-xl:w-[5%] flex items-center justify-center">in</div>
...
//                             {["USA", "Canada", "United Kingdom", "Ireland", "New Zealand", "Australia", "Germany"].map(
//                                 (country) => (
//                                     <li
//                                         key={country}
...
//                     value={addCourseData?.university_ranking || ''}
//                     onChange={handleUniversityRankingChange}
//                 />
//             </div>
//             </div>
//             <div className="border-[#BFBFBF] border-b-[1px] my-5"></div>
...
//                     {/* University Logo */}
//                     <div className="w-[25%] max-xl:w-[25%] flex items-center justify-center">Upload University Logo</div>
//                     <div>
//                         <div className="">
//                             <label
...
//                                 {["Less than a year", "1 year", "2 years", "3 years", "4 years", "5 years", "6 years"].map(
//                                     (duration) => (
//                                         <li
//                                             key={duration}
...
//                         </div>
//                     )}
//                     <div className="w-[25%] max-xl:w-[25%] flex items-center justify-center">Application Deadline</div>
//                     <input
//                         className="w-[25%] max-xl:w-[30%] bg-[#F9F9F9] border border-[#898C9A] rounded-md placeholder:text-[0.8rem]"
...
//                                         value={intake.month}
//                                         onChange={(e) => handleIntakeChange(index, 'month', e.target.value)}
//                                     >
...
//                                 value={intake.year}
//                                 onChange={(e) => handleIntakeChange(index, 'year', e.target.value)}
//                                 >
...
//                             onChange={(e) => handleTestRequirementChange(index, 'testRequirement', e.target.value)}
//                         >
//                             <option value="Select" disabled>Select Requirement</option>
...
//                         </select>
//                         <div className="w-[25%] flex items-center justify-center">Overall Required Score</div>
//                         <input
//                             className="w-[25%] bg-[#F9F9F9] border-[#898C9A] rounded-md"
//                             placeholder="Enter here"
//                             value={requirement.overallScore}
//                             onChange={(e) => handleTestRequirementChange(index, 'overallScore', e.target.value)}
//                         />
//                         {index > 0 && (
//                             <button type="button" onClick={() => handleRemoveTestRequirement(index)} className="ml-4 text-red-500">
//                                 <img src={trashclose} alt="remove" width={16} />
//                             </button>
//                         )}
//                     </div>
...
//                     <div key={index} className="flex text-[0.9rem] mt-4 items-center">
//                         <div className="w-[20%] max-xl:w-[15%]">Eligibility Requirements</div>
//                         <select
//                             className="w-[30%] px-5 py-1 text-[#898C9A] border-[#898C9A] bg-[#F9F9F9] rounded-md"
//                             value={req.requirementType}
//                             onChange={(e) => handleEligibilityInputChange(index, 'requirementType', e.target.value)}
//                         >
//                             <option value="" disabled>Select Requirement</option>
//                             <option value="Min GPA">Min GPA</option>
//                             <option value="Backlogs Applicable">Backlogs Applicable</option>
//                             <option value="Backlogs Not Applicable">Backlogs Not Applicable</option>
...
//                                 value={req.gpaRange}
//                                 onChange={(e) => handleEligibilityInputChange(index, 'gpaRange', e.target.value)}
//                             />
//                         )}
...
//                                 onChange={(e) => handleEligibilityInputChange(index, 'backlogRange', e.target.value)}
//                             />
//                         )}
//                         {index > 0 && (
//                             <button type="button" onClick={() => handleEligibilityRemoveRequirement(index)} className="ml-4 text-red-500">
//                                 <img src={trashclose} alt="remove" width={16} />
//                             </button>
//                         )}
//                     </div>
...
//                         <div className="w-[20%] max-xl:w-[15%]">Application Requirements</div>
//                         <input
//                             className="w-[30%] bg-[#F9F9F9] border border-[#898C9A] rounded-md placeholder:text-[0.8rem]"
//                             placeholder="Enter requirement"
//                             value={requi.requirement}
//                             onChange={(e) => handleApplicationInputChange(index, 'requirement', e.target.value)}
//                         />
...
//                                 onChange={(e) => handleApplicationInputChange(index, 'isRequired', e.target.checked)}
//                             />
//                             <div>Required</div>
//                         </div>
//                         {index > 0 && (
...
//                 onChange={(e) => handleTopRecruitersInputChange(index, 'recruiters_name', e.target.value)}
//             />
//             {/* Recruiter Logo Input */}
//             <div className="w-[25%] max-xl:w-[25%] flex items-center justify-center">Recruiter Logo</div>
//             <div>
//                 <label
...
//                     {/* Funding Options */}
//                     <div className="w-[25%] flex items-center justify-center ml-12">Funding Options</div>
...
//                                     onChange={(e) => handleFundingOptionChange(index, e.target.value)}
//                                 >
//                                     <option value="Select" disabled>Select</option>
          ...
          {isOpenDiscipline && (
            <div className="absolute mt-10 ml-[34.2rem] max-xl:ml-[20.6rem] w-[15%] max-xl:w-[18%] bg-[#F9F9F9] border border-[#898C9A] rounded-md shadow-lg z-10">
              <ul className="text-[0.8rem] h-[29vh] overflow-y-auto">
                ...
                <li
                  onClick={() => handleDiscipline("Engineering")}
                  className="px-4 py-2 cursor-pointer hover:bg-[#7f848dda] hover:text-white"
                >
                  Engineering
                </li>
                <li
                  onClick={() => handleDiscipline("Business")}
                  className="px-4 py-2 cursor-pointer hover:bg-[#7f848dda] hover:text-white"
                >
                  Business
                </li>
                <li
                  onClick={() => handleDiscipline("Medicine")}
                  className="px-4 py-2 cursor-pointer hover:bg-[#7f848dda] hover:text-white"
                >
                  Medicine
                </li>
                ...
                <li
                  onClick={() => handleDiscipline("Science")}
                  className="px-4 py-2 cursor-pointer hover:bg-[#7f848dda] hover:text-white"
                >
                  Science
                </li>
                <li
                  onClick={() => handleDiscipline("Law")}
                  className="px-4 py-2 cursor-pointer hover:bg-[#7f848dda] hover:text-white"
                >
                  Law
                </li>
