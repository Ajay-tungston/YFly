...
const AddNewCourse = ({ setAddingNewCourse }) => {
    const [addCourseData, setAddCourseData] = useState({
        ...
        overview: "",
        intakes: [{ month: "", year: "" }],
        testRequirements: [{ testRequirementName: "Requirement 1", overallScore: "" }],
        eligibilityRequirements: [
            {
                requirementType: "",
                gpaRange: "",
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setAddCourseData({
                ...
                intakes: [{ month: "", year: "" }],
                testRequirements: [{ testRequirementName: "Requirement 1", overallScore: "" }],
                eligibilityRequirements: [{requirementType: "", gpaRange: "", backlogRange: "",  workExperience: "", entranceExam: "" }],
                application_requirements: [{ requirement: "", isRequired: false }],
                job_roles: [{ jobrole: "" }],
                top_recruiters: [{ recruiters_name: "", logo: null }],
                scholarship_applicable: [{ scholarship: "" }],
