...
const Masters = ({ onOpenMajorSelection }) => {
  ...
  return (
      ...
      <div className='bg-white max-md:w-[80%] max-md:p-7 py-10 px-16 rounded-[40px]'>
        ...
        <div className='gap-4 max-lg:gap-2 grid grid-cols-2 max-md:grid-cols-1  justify-center mt-8 max-md:mt-5 text-[#2B7CD6] font-dela'>
          {['UG Degree', 'PG Degree', 'UG Diploma', 'PG Diploma'].map((education) => (
            <div
              key={education}
              className={` active:scale-95 transition transform duration-150 hover:shadow-lightshad max-md:text-[0.8rem] max-lg:text-[0.9rem] text-center border-black border-[1px] mr-6 max-lg:mr-0 py-5 max-md:py-3 px-9 rounded-[18px] cursor-pointer ${
        ...
        <div className='text-center font-dela text-[#2B7CD6] max-md:text-[0.8rem] mt-10 max-md:mt-5'>Expected or gained percentage</div>
        ...
        <div className='flex justify-end mt-10 max-md:mt-5'>
          ...
          <button
            ...
            className={`px-8 py-2 border border-black  max-md:text-[0.8rem] font-bold rounded-full transition transform duration-150 ${
