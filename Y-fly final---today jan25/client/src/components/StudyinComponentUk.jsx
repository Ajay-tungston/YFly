                        ...
                        <div className=' relative border-[1px] h-[300px] border-black rounded-[38px] shadow-right-bottom bg-white w-screen'>
                            ...
                            <div className='flex justify-between max-lg:flex-col items-center h-[300px] px-28 max-lg:py-10'>
                                ...
                                <div className='flex max-lg:-ml-5 max-md:-ml-0'>
                                    ...
                                    <div className='ml-3'>
                                        <div className='text-[13px] max-xl:text-[10px] font-urban text-[#898C9A]'>Tuition fees</div>
                                        <div className='text-[#30589F] font-lato text-[20px] max-xl:text-[15px]'>$14,000</div>
                                    </div>
                                </div>
                                ...
                                <div className='flex items-center max-md:-ml-0'>
                                    ...
                                    <div className='ml-3'>
                                        ...
                                        <div className='text-[#30589F] font-lato text-[20px] max-xl:text-[15px]'>$9,600</div>
                                    </div>
                                </div>
                                ...
                                <div className='flex max-lg:-ml-12 max-md:-ml-2'>
                                    ...
                                    <div className='ml-3'>
                                        ...
                                        <div className='text-[#30589F] font-lato text-[20px] max-xl:text-[15px]'>$4</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        {universities.map((u) => (
                            <div className=' border-[1px] w-[32%] max-xl:w-[49%] max-md:w-[98%] border-black rounded-[38px] hover:shadow-right-bottom bg-white p-6 mb-3'>
                                ...
                                <div className='flex justify-between mt-6 items-center'>
                                    <div>
                                        <div className=' font-urban max-lg:text-[13px]'>{u.university}</div>
