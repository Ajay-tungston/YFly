...
const Degree = ({ onOpenBachelors, onOpenMasters, onOpenMba }) => {
  ...
  const [selectedDegree, setSelectedDegree] = useState(formData.selectedDegree);
  const navigate = useNavigate();

  const handleSelectDegree = (degree) => {
    setSelectedDegree(degree);
    updateFormData({ selectedDegree: degree }); 
          ...
          <div className="mt-10 max-md:mt-4 flex justify-between max-md:flex-col max-md:items-center">
            ...
            <button
              ...
              className={`w-[30%] max-md:w-[90%] max-md:mb-2 ${
                selectedDegree === 'Bachelors' ? 'bg-[#30589f] text-white shadow-lightshad' : 'bg-white text-[#2b7cd6]'
            ...
            >
              <div className="flex justify-center">
                <img src={bachelor} width={80} alt="bachelor" className=" max-md:w-[4rem]" />
              </div>
              <div className="text-center font-dela mt-3 text-[18px] max-md:text-[0.8rem]">Bachelors</div>
            </button>
            ...
            <button
              ...
              className={`w-[30%] max-md:w-[90%] max-md:mb-2 ${
                selectedDegree === 'Masters' ? 'bg-[#30589f] text-white shadow-lightshad' : 'bg-white text-[#2b7cd6]'
              } border hover:bg-[#30589f] hover:text-white hover:shadow-lightshad border-[#0e1b2c] active:scale-95 transition transform duration-150 text-[1rem] font-dela py-6 max-md:py-4 px-2 rounded-3xl`}
            >
              <div className="flex justify-center">
                <img src={master} width={80} alt="masters" className=" max-md:w-[4rem]" />
              </div>
              <div className="text-center font-dela mt-3 text-[18px] max-md:text-[0.8rem]">Masters</div>
            </button>
            ...
            <button
              ...
              className={`w-[30%] max-md:w-[90%] ${
                selectedDegree === 'MBA' ? 'bg-[#30589f] text-white shadow-lightshad' : 'bg-white text-[#2b7cd6]'
              } border hover:bg-[#30589f] hover:text-white hover:shadow-lightshad border-[#0e1b2c] active:scale-95 transition transform duration-150 text-[1rem] font-dela py-6 max-md:py-4 px-2 rounded-3xl`}
            >
              <div className="flex justify-center">
                <img src={master} width={80} alt="mba" className=" max-md:w-[4rem]" />
              </div>
              <div className="text-center font-dela mt-3 text-[18px] max-md:text-[0.8rem]">MBA</div>
            </button>
          </div>
        </div>
      </div>
