    ...
    return (
        <div>
            <div className=" bg-white bg-cover bg-center rounded-[200px] max-md:rounded-[80px] pt-16 px-24 pb-32 mt-10 max-xl:px-16 max-lg:px-10 max-md:px-5"
                ...
                <div className='bg-[#30589F]  rounded-[38px] px-6 pt-16 max-md:px-3 max-md:pt-3 text-[15px] max-md:text-[10px] text-[#0E1B2C] p-10'>
                    <div className='flex  '>
                    ...
                    <div className='flex '>
                        <div className='bg-white py-[1.8rem]  w-[50%] text-center px-[4rem] max-md:px-4 max-md:w-[50%] mb-6 mr-6 max-md:mr-3 max-md:mb-3 font-dela  rounded-[30px] max-lg:px-[3.5rem]'>Opportunities for Research, Teaching and Graduate Assistantships</div>
                        <div className='bg-white py-[1.8rem]  w-[50%] text-center px-[5.2rem] max-md:px-4 max-md:w-[50%] max-xl:px-[2.5rem] mb-6 max-md:mb-3 font-dela  rounded-[30px] max-lg:px-[3.5rem]'>Best of 12 Student Cities (QS 2023)</div>
                    </div>

                    <div className='flex'>
                        <div className='bg-white py-[1.8rem]  w-[50%] text-center px-[3.5rem] max-md:px-4 max-md:w-[50%] mb-6 mr-6 max-md:mr-3 max-md:mb-3 font-dela  rounded-[30px] max-lg:px-[3.5rem]'>Merit based and Need based scholarships</div>
                        <div className='bg-white py-[1.8rem]  w-[50%] text-center px-[4.2rem] max-md:px-4 max-md:w-[50%] mb-6 max-md:mb-3 font-dela  rounded-[30px] max-lg:px-[3.5rem]'>Post-study stay back visas (OPT) up to 3 years for STEM programs</div>
                    </div>

                    <div className='flex'>
                        <div className='bg-white py-[1.8rem]  w-[50%] text-center px-[3.2rem] max-md:px-4 max-md:w-[50%] mr-6 mb-6 max-md:mr-3 max-md:mb-3  font-dela  rounded-[30px] max-lg:px-[3.5rem]'>Over 4500 accredited universities & institutions to choose from</div>
                        <div className='bg-white py-[1.8rem]  w-[50%] text-center px-[3.2rem] max-md:px-4 max-md:w-[50%] mb-6 max-md:mb-3 font-dela  rounded-[30px] max-lg:px-[3.5rem]'>25% of world’s top 100 universities are in the USA</div>
                    </div>
                </div>
                ...
                {/*---------------------------------------- contact us section------------------------------ */}
                <div>
                    <div className='text-[#2B7CD6] font-dela text-[2rem] max-lg:text-[1.4rem]  pl-10 mt-16 mb-8 '>Top Courses</div>
                    <Topcourse />
                </div>
                <div>
                    <div className='text-[#2B7CD6] font-dela text-[2rem] max-lg:text-[1.4rem]  pl-10 mt-16 mb-8 '>Top Scholarships</div>
                    <Scholarships />
                </div>

                <div>
                    <div className='text-[#2B7CD6] font-dela text-[2rem] max-lg:text-[1.4rem]  pl-10 mt-16 mb-8 '>Top Domains</div>
                    <Domain />
                </div>
                <div>
                    <div className='text-[#2B7CD6] font-dela text-[2rem] max-lg:text-[1.4rem]  pl-10 mt-16 mb-8 '>Intake Schedule</div>
                    <Intake />
                </div>
            </div>
